    ...
    <form ref={formRef} onSubmit={handleSubmit} className="max-w-3xl">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
        ...
        <div>
          ...
          <textarea name="description" required rows={2} defaultValue={project?.description}
        ...
        <div>
          ...
          <textarea name="detail" required rows={5} defaultValue={project?.detail}
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all text-sm text-gray-600">
              ...
              Chọn ảnh đại diện
              <input name="main_image" type="file" accept="image/*" className="hidden" onChange={handleMainImageChange} />
            </label>
            <p className="text-xs text-gray-400 mt-2">PNG, JPG, WEBP · Tự động upload lên Cloudinary</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-5">
        ...
        <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all text-sm text-gray-600">
          ...
          Thêm ảnh thư viện
          <input name="gallery_images" type="file" accept="image/*" multiple className="hidden" onChange={handleGalleryChange} />
        </label>
        <p className="text-xs text-gray-400 mt-2">Có thể chọn nhiều ảnh cùng lúc</p>
      </div>
